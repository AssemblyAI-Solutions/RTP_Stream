...
const RTSP_URL = "rtsp://wowzaec2demo.streamlock.net/vod/mp4:BigBuckBunny_115k.mp4" // TODO: replace with your RTSP URL

const WebSocket = require('ws');
const spawn = require('child_process').spawn;

const word_boost = [] // TODO: Add custom vocabulary to boost e.g. ['foo', 'bar']
const params = {"sample_rate": 8000, "word_boost": JSON.stringify(word_boost)}
...
ws.on('open', function open() {
    const ffmpeg = spawn('ffmpeg', ['-rtsp_transport', 'tcp', '-i', RTSP_URL, '-acodec', 'pcm_s16le', '-ac', '1', '-ar', '16000', '-f', 's16le', '-']);
